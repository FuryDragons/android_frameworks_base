...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        */
         ...
         * @hide
         */
        public static final String STATUS_BAR_FDS_LOGO = "status_bar_fds_logo";

        /**
         * Statusbar FDS logo color setting
         * @hide
         */
        public static final String STATUS_BAR_FDS_LOGO_COLOR = "status_bar_fds_logo_color";
         ...
         * @hide
         */
        public static final String STATUS_BAR_FDS_LOGO_STYLE = "status_bar_fds_logo_style";
